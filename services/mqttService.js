...
let _mqttEventHandler = null;

function initializeMqttBroker(mqttEventHandler) {
  _mqttEventHandler = mqttEventHandler;
    ...
    if (client) {
      ...
      if (topic.startsWith('shuttle/information/')) {
        ...
        try {
          ...
          if (_mqttEventHandler && mqttEvent && mqttEvent.event) {
            _mqttEventHandler.emitShuttleEvent(mqttEvent);
